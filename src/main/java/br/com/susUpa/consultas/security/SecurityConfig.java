    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers(HttpMethod.GET, "/attendance", "/attendance/search").hasAnyRole("ADMIN", "ATENDENTE", "PACIENTE", "MEDICO", "AGENTEDESAUDE")
                ...
                .requestMatchers(HttpMethod.DELETE, "/appointments/**").hasAnyRole("ADMIN", "ATENDENTE", "PACIENTE", "AGENTEDESAUDE")
